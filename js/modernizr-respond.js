...
! function (e, t, n) {
    ...
    function v(e, t, o, i) {
        ...
        for (var c, d, p, m, v, g = ["modernizr", "tspan"]; !A.style;) c = !0, A.modElem = l(g.shift()), A.style = A.modElem.style;
        for (p = e.length, d = 0; p > d; d++)
            if (m = e[d], v = A.style[m], f(m, "-") && (m = s(m)), A.style[m] !== n) {
    ...
    var C = [],
        ...
        Modernizr = function () {};
    Modernizr.prototype = w, Modernizr = new Modernizr, Modernizr.addTest("history", function () {
    ...
    var E = "Moz O ms Webkit",
        T = w._config.usePrefixes ? E.toLowerCase().split(" ") : [];
    w._domPrefixes = T;
    var P;
    ! function () {
        ...
        w.addTest = a
    }), Modernizr.addTest("svgasimg", t.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image", "1.1")), Modernizr.addTest("video", function () {
        var e = l("video"),
            t = !1;
        try {
    ...
    var z = "CSS" in e && "supports" in e.CSS,
        N = "supportsCSS" in e;
    Modernizr.addTest("supports", z || N);
    var j = w._config.usePrefixes ? E.split(" ") : [];
    w._cssomPrefixes = j;
    var k = function (t) {
        var r, o = x.length,
            i = e.CSSRule;
    ...
    w.testAllProps = y, Modernizr.addTest("cssanimations", y("animationName", "a", !0)), Modernizr.addTest("csstransforms", function () {
        ...
        return e
    }), Modernizr.addTest("csstransitions", y("transition", "all", !0)), o(), i(C), delete w.addTest, delete w.addAsyncTest;
    for (var L = 0; L < Modernizr._q.length; L++) Modernizr._q[L]();
    e.Modernizr = Modernizr
}(window, document);
// Hover test for Modernizr
Modernizr.addTest("mousehover", function () {
    var e, o = "(any-hover: hover)",
        r = !Modernizr.touchevents;
    return "matchMedia" in window && (e = window.matchMedia(o), e.media === o && (r = e.matches && document.documentElement.clientWidth >= 768)), r
});
